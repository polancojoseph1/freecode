...
export namespace TuiConfig {
  ...
  const state = Instance.state(async () => {
    ...
    // Initialize all promise structures at the top to allow concurrent I/O operations.
    // They are then awaited sequentially to preserve proper merging precedence.
