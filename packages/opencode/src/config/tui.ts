...
export namespace TuiConfig {
  ...
  const state = Instance.state(async () => {
    ...
    // ⚡ Bolt: Parallelize all independent config loading
    // Instead of awaiting each tier sequentially, we launch all file loading at once
    // then merge them in priority order to reduce total blocking IO time.
