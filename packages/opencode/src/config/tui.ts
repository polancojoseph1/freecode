...
export namespace TuiConfig {
  ...
  const state = Instance.state(async () => {
    ...
    // Initialize all independent I/O promises concurrently to eliminate sequential blocking
    ...
    // Await all independent I/O tasks concurrently
    const [
      globalInfos,
      customInfo,
      projectInfos,
    ...
    // Merge configurations sequentially to preserve strict override priority
