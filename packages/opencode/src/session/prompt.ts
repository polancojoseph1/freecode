...
export namespace SessionPrompt {
  ...
  async function invokeTaskTool(input: {
    task: any
    ...
    const { task, model, sessionID, lastUser, session, msgs, abort } = input
    ...
    const assistantMessage = (await Session.updateMessage({
      ...
      modelID: "modelID" in taskModel ? taskModel.modelID : taskModel.id,
    ...
    const result = await ToolInvoke.execute("task", taskArgs, taskCtx, (args, ctx) => taskTool.execute(args, ctx)).catch((error) => {
