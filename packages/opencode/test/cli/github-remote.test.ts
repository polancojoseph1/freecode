...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/freecode.git")).toEqual({ owner: "sst", repo: "freecode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/freecode")).toEqual({ owner: "sst", repo: "freecode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/freecode.git")).toEqual({ owner: "sst", repo: "freecode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/freecode")).toEqual({ owner: "sst", repo: "freecode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/freecode.git")).toEqual({ owner: "sst", repo: "freecode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/freecode")).toEqual({ owner: "sst", repo: "freecode" })
})
