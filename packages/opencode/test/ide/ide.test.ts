...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders FREECODE_CALLER", () => {
    process.env["FREECODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode FREECODE_CALLER", () => {
    process.env["FREECODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown FREECODE_CALLER", () => {
    process.env["FREECODE_CALLER"] = "unknown"
