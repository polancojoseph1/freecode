...
export function approxBytes(content: FileContent) {
  ...
  if (hunks) {
    // Optimization: Standard for-loops avoid per-element function/closure allocations
    // compared to nested Array.reduce(), significantly improving throughput on large patches.
