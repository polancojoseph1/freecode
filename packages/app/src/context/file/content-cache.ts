...
export function approxBytes(content: FileContent) {
  let patchBytes = 0
  // ⚡ Bolt: Replacing .reduce() with standard nested for loops to eliminate function allocation overhead
  // on a critical hot-path (processing large patch arrays) to speed up byte calculations.
