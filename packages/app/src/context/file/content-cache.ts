...
export function approxBytes(content: FileContent) {
  ...
  // Using nested for-loops instead of .reduce() on potentially large arrays (hunks/lines)
  // eliminates intermediate function allocations per element in this hot path calculation.
  if (hunks) {
