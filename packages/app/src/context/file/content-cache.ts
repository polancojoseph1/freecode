...
export function approxBytes(content: FileContent) {
  ...
  // ⚡ Bolt: Replaced nested .reduce() with for loops to eliminate closure allocation
  // overhead on the hot path for large arrays of patch hunks/lines in the LRU cache.
