...
export function approxBytes(content: FileContent) {
  ...
  // ⚡ Bolt: Replaced nested reduce calls with for loops on this LRU cache byte estimation hot-path
  // to avoid creating intermediate arrays and per-element closure allocations.
  if (hunks) {
