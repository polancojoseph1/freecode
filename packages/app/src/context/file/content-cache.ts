...
export function approxBytes(content: FileContent) {
  // Optimization: replaced chained reduce calls with nested loops to avoid function
  // allocation overhead on large diffs, since this runs on LRU updates for file contents.
  let patchBytes = 0
